...
public class LbcDialog : IDisposable
{
    ...
    private void handleListBoxCopyKeys(object sender, KeyEventArgs evArgs)
    {
        ...
        // family: Ctrl+C copies the file NAME, Ctrl+Shift+C copies the full
        // PATH (with the files themselves in the same clipboard), and Alt+C
        // appends the paths.
        ...
        // None of the three may fall through to the generic copy below: it
        // would put the RAW LIST ROW on the clipboard - the decorated display
        // text, not the name or the file the user asked for.
