...
Source: "ZapisFormatow.cs";   DestDir: "{app}"; Flags: ignoreversion
Source: "PdfExport.cs";       DestDir: "{app}"; Flags: ignoreversion
Source: "OriginalFormatSave.cs"; DestDir: "{app}"; Flags: ignoreversion
