@echo off
rem Kompiluje i uruchamia pomiar granic slow (zgloszenie 15.09.2026).
...
"!csc!" /nologo /utf8output /codepage:65001 /target:exe /reference:"System.Windows.Forms.dll" /reference:"!uiaClient!" /reference:"!uiaTypes!" /out:pomiar_granice_slow.exe pomiar_granic_slow_608.cs
if errorlevel 1 (echo BLAD KOMPILACJI & popd & exit /b 3)
pomiar_granice_slow.exe %*
set "kod=%errorlevel%"
popd
exit /b %kod%
